...
int main(int argc, char *argv[]) {
    ...
    fprintf(stdout, "Enqueue 10 elements\n");
    for (i = 0; i < 10; ++i) {
    ...
    fprintf(stdout, "Dequeue 5 elements\n");
    ...
    fprintf(stdout, "Enqueue 100 and 200\n");
    if ((data = (int *) malloc(sizeof(int))) == NULL) {
        return 1;
    }
    *data = 100;
    ...
    *data = 200;
    ...
    if ((data = queue_peek(&queue)) != NULL)
        fprintf(stdout, "Peeking at the head element...Value=%d\n", *data);
    else
